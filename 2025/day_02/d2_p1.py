# Note: In p2, I switched to a much faster approach for performance (by generating rather than scanning all IDs); that strategy could be applied here as well with minor adjustments.
